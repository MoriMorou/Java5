...
public class FileInfo implements Serializable {
    ...
    public static class FileInfoBuilder {
        ...
        // FIXME: Стоит ли связываться с шифровкой и токенами 2019-02-26
        // FIXME: Все еще не знаю как часто стоит обновлять таблицы и как отразить изображение на картинке 2019-02-26
        private String id;
        private String filename;
        private Long createdTimestamp;
        private Long size;
